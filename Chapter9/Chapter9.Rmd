...
#set the global argument
knitr::opts_chunk$set(echo = TRUE)
#get rid of the annoying # sign 
...
summary(tune.out)
best.cost<-tune.out$best.parameters
```

we see that `r best.cost` results in the lowest coss-validation error
...
The training error was 15/70 and the test error was 7/30.


Using suppor classifer, which is the linear method or polynominal that degree=1
The training error was 4/70 and the test error was 2/30
...
In this situation, the kernel out perform the rest method, gives test error of 0.and training error of 2
