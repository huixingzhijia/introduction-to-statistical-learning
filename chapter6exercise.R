...
plot(cv.lasso.mod)
lasso.pred
#lasso picks X,x^2,x^3, x^5,x^7 with negligible coefficients
...
#using adjusted-Rsquare
plot(b.summary$adjr2,xlab="Number of variables",ylab="Adjusted RSQ",type="l")
which.max(b.summary$adjr2)
points(7,b.summary$adjr2[7],col="red",cex=2,pch=20)


#Using AIC method
plot(b.summary$cp,xlab="Number of Variables",ylab="AIC",type="l")
which.min(b.summary$cp)
points(7,b.summary$cp[7],col="red",cex=2,pch=20)
#number of variable is 3 gives the minimum AIC 

#Using BIC method
plot(b.summary$bic,xlab="Number of Variables",ylab="BIC",type="l")
which.min(b.summary$bic)
points(7,b.summary$bic[7],col="red",cex=2,pch=20)
#number of variable is 7 gives the minimum BIC
...
#c
ref.fit.best<-regsubsets(y ~ . ,data=data,nvmax=p)
